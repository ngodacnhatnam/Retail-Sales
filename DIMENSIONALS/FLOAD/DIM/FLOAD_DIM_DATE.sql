...
SET NOCOUNT ON
SET XACT_ABORT ON
--SET IDENTITY_INSERT dw_future_sales.dbo.DIM_DATE ON

BEGIN TRAN;
BEGIN TRY;


	TRUNCATE TABLE dw_future_sales.dbo.DIM_DATE;
	...
	BEGIN
		...
		INSERT INTO dw_future_sales.dbo.DIM_DATE(DATE_KEY, DATE,DAY,DAY_OF_WEEK,DAY_OF_WEEK_NUMBER ,MONTH,MONTH_NUMBER,QUARTER,
